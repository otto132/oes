      ...
      {toasts.map(toast => {
        ...
        return (
          ...
          >
            ...
            <span className="text-[12px] text-[var(--text)] leading-snug flex-1">{toast.message}</span>
            <button
            ...
            <div className={`absolute bottom-0 left-0 h-[2px] ${colors.bar} opacity-40 toast-progress`} />
          </div>
        );
      })}
    </div>
