  ...
  return (
    <header className="fixed top-0 left-0 md:left-[220px] right-0 h-12 bg-elevated/80 backdrop-blur-sm border-b border-border flex items-center gap-3 px-4 md:px-6 z-20">
      ...
      <div className="flex items-center gap-1.5 ml-auto">
        ...
        <div className="hidden md:flex w-7 h-7 rounded-md bg-surface border border-border text-sub items-center justify-center text-[10px] font-semibold cursor-pointer hover:border-border-strong transition-colors">JK</div>
      </div>
    </header>
  );
}
