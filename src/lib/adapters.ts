...
export function adaptLead(l: {
  ...
  return {
    ...
    certMgmtType: (l as any).certMgmtType || '',
    etrmSystem: (l as any).etrmSystem || '',
    gtrmSystem: (l as any).gtrmSystem || '',
    certRegistries: (l as any).certRegistries || [],
    itIntegrations: (l as any).itIntegrations || [],
    certPainPoints: (l as any).certPainPoints || '',
    owner: l.owner ? adaptUser(l.owner) : null,
...
export function adaptAccount(a: {
  ...
  return {
    ...
    scores: adaptFIUAC(a),
    ownerId: a.ownerId,
    owner: a.owner ? adaptUser(a.owner) : null,
    pipelineValue: a.pipelineValue,
    lastActivityAt: a.lastActivityAt.toISOString(),
    certMgmtType: (a as any).certMgmtType || '',
    etrmSystem: (a as any).etrmSystem || '',
    gtrmSystem: (a as any).gtrmSystem || '',
    certRegistries: (a as any).certRegistries || [],
    itIntegrations: (a as any).itIntegrations || [],
    certPainPoints: (a as any).certPainPoints || '',
    pain: a.pain,
    whyNow: a.whyNow,
...
export function adaptOpportunity(o: {
  ...
  return {
    ...
    owner: o.owner ? adaptUser(o.owner) : null,
...
export function adaptTask(t: {
  ...
  return {
    ...
    owner: t.owner ? adaptUser(t.owner) : null,
