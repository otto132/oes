...
function InboxSkeleton() {
  return (
    <div className="flex h-[calc(100vh-64px)]">
      <div className="w-80 border-r border-[var(--border)] p-3 space-y-2">
        {Array.from({ length: 6 }).map((_, i) => (
          <SkeletonCard key={i}><SkeletonText /><SkeletonText className="w-2/3" /></SkeletonCard>
        ))}
      </div>
      <div className="flex-1 p-4"><SkeletonCard className="h-40" /></div>
      <div className="w-72 border-l border-[var(--border)] p-3"><Skeleton className="h-24" /></div>
    </div>
  );
}
...
export default function InboxPage() {
  ...
  return (
    <div className="flex h-[calc(100vh-64px)] bg-[var(--page)]">
      ...
      <div className="w-80 border-r border-[var(--border)] flex flex-col bg-[var(--elevated)]">
      ...
      <div className="w-72 border-l border-[var(--border)] bg-[var(--elevated)]">
        <InboxContext
